...
#define BL_NAVIGATIONBAR_HEIGHT  ([UIApplication sharedApplication].statusBarFrame.size.height+44)
#define BL_STATUSBAR_HEIGHT  ([UIApplication sharedApplication].statusBarFrame.size.height)
#define BL_TABBAR_HEIGHT  ([UIApplication sharedApplication].statusBarFrame.size.height == 20?49:83)
