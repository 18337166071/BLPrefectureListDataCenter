...
- (NSDate *) hoursLater:(float)hours;       //几小时后
...
//返回几天后的日期 格式yyyy-MM-dd
- (NSString *)dateStringLater:(NSInteger)days;
/*
inputFormat:@"yyyy-MM-dd HH:mm:ss" outputFormat:@"yyyyMMdd"
inputFormat:@"yyyy-MM-dd HH:mm:ss" outputFormat:@"HHmmss"
 */
