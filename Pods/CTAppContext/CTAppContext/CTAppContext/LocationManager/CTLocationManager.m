...
NSString * const kCTLocationManagerDidUpdateLocationNotification = @"kCTLocationManagerDidUpdateLocationNotification";
...
@property (nonatomic, copy, readwrite) CLPlacemark *currentPlacemark;
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kCTLocationManagerDidUpdateLocationNotification object:self userInfo:nil];
